...
var RegisterConfirmationComponent = /** @class */ (function () {
     ...
     */
    function RegisterConfirmationComponent(router, activatedRoute, translate) {
        this._router = router;
    ...
    RegisterConfirmationComponent.prototype.confirmAccount = function () {
        ...
        user_model_1.UserModel.confirmAccount(this.token).subscribe(function (result) {
            if (result.status == true) {
                ...
                notification_service_1.NotificationService.danger(_this._translate.instant("account-confirm-error"));
            }
        });
    };
